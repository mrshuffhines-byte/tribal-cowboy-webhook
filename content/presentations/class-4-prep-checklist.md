...
- [x] Run practice session #1 — Word Racer with the 3D printed Magic E wand, Charlie (6) and Charlie the Fjord, Fri Aug 21 at the ranch
- [x] Run practice session #2 — Pony Express Mailbox at the trailer: a letter on the mailbox, 3D printed discs, a point for every real word she got in
...
- [ ] Read the reflection slides out loud once (4, 6, 7, 8) and adjust any line that does not sound like you
...
| Slide | Status |
|---|---|
| 2 | Done — Session 1: Word Racer (CVC & Magic E), Session 2: Pony Express Mailbox (letter + 3D discs), both with Charlie (6) and Charlie the Fjord, Fri Aug 21 |
| 3 & 5 | Done — write ups match the videos: pony picked the word cards on the cone line; W on the mailbox, 3D printed discs, a point per word mailed |
