# The Pony Post
## A 4-Week Reading Sprint for Preschool through 2nd Grade
### Tribal Cowboy LLC — Athol, Idaho

**Program:** The Pony Post
**Tagline:** *Where the pony writes back.*
**Target ages:** Preschool, Pre-K, Kindergarten, 1st grade, 2nd grade (ages 3–8)
**Two age tracks:** Pre-K Track (ages 3–5) + K-2 Track (ages 5–8)
...
The Pony Post is a 4-week classroom literacy program where a real pony comes to school once a week, helps teach the lesson, and **mails the class a hand-folded letter between visits.** Three weeks of pen-pal letters build up to a final reveal: a real Clydesdale shows up at school or hosts the class at the ranch.
...
## The 5 Pillars Map (for sponsors & grant reviewers)

The Pony Post hits all five pillars of reading instruction from the National Reading Panel framework. Each week leads with one pillar.

| Pillar | Where it's taught |
|---|---|
| **Phonemic & phonological awareness** | Week 2 — syllable counting with the pony (her hoof paws out each syllable) |
| **Phonics** | Embedded — short vowel sounds in sight words across all 4 weeks |
| **Fluency** | Week 3 — "Read to the Pony" — kids read aloud to a non-judging animal audience |
| **Vocabulary** | All 4 weeks — 20 new words per track |
| **Comprehension** | Week 4 — book discussion + word recognition assessment + sponsor outcome data |

**Idaho ELA standards hit:**
- K.RF.2.b / 1.RF.2 (count, pronounce, blend, segment syllables — Week 2)
- K.RF.3.c / 1.RF.3.g / 2.RF.3.f (sight word fluency — Weeks 1–4)
- 1.RF.4 / 2.RF.4 (read with accuracy and fluency to support comprehension — Week 3)
- K.RF.4 / 1.RF.4 (read emergent-reader texts with purpose and understanding — Week 4)
...
1. **Short, varied blocks.** No activity longer than 7 min (Pre-K) or 10 min (K-2).
...
9. **Spot markers.** Every kid has a hay-bale square or yoga mat as a visual home base.
...
## The 20 Sight Words (K-2 Track Only)

All Dolch Pre-Primer + Primer words. Idaho ELA-aligned.

| Week | Words | Idaho ELA Standard |
|---|---|---|
| Week 1 | I, am, a, the, you | K.RF.3.c, 1.RF.3.g |
| Week 2 | and, see, can, like, my | K.RF.3.c, 1.RF.3.g |
| Week 3 | he, she, we, said, go | 1.RF.3.g, 2.RF.3.f |
| Week 4 | this, was, with, are, on | 1.RF.3.g, 2.RF.3.f |

Teacher administers a quick before/after check (read all 20 words aloud privately to each kid, mark recognition). This becomes the sponsor outcome data.
...
| Week | Words |
|---|---|
| Week 1 | hoof, mane, tail, eye, soft |
| Week 2 | brown, white, hay, friend, gentle |
| Week 3 | share, kind, help, listen, breathe |
| Week 4 | big, small, together, ranch, goodbye |

---

## The Pony's Opening (default + situational versions)

**Default opening (Version A — most North Idaho schools):**

> *"Hi everybody, I'm Stacie. I'm Nisenan Maidu — my family comes from Northern California, but I live and work right here in Athol with my horses. This is my pony."*

Stacie's identity is mentioned as a fact about her, like any teacher mentioning where they're from. Not framed as the lesson.

**Situational opening (Version B — when the room welcomes it):**

> *"I'm Stacie. I'm Nisenan Maidu, and my family is originally from Northern California. The land we're on today is the traditional home of the Schitsu'umsh people — the Coeur d'Alene Tribe. This is my pony."*

Use Version B when the school has explicitly asked for cultural programming, during Native American Heritage Month visits, or at a tribal school. Otherwise Version A.
...
Two body-action callbacks the kids learn at Visit 1 and use across all four weeks.
...
The teacher reads the class a short Welcome Letter from the pony — the first Pony Post delivery.
...
# Pony Post #1 — Between Visit 1 and Visit 2

*Print on 8.5×11, fold like a real letter, slip into a hand-stamped envelope. Teacher reads aloud Monday morning.*

## K-2 Letter

> Hi friends!
>
> Thanks for being so kind to me last week. I had so much fun meeting you. Stacie says you are her favorite class.
>
> I have been practicing the words you taught me. Watch me try!
>
> **I am a pony!**
> **You are my friends!**
> **The grass is yummy!**
>
> Did you see those words? They are called sight words. Sight words are tricky little words that show up everywhere when we read.
>
> Last week we learned five. This week I want you to learn five new ones:
>
> **and, see, can, like, my**
>
> Try this for me. Read this sentence to your grown-up tonight:
>
> *"I can see my pony. I like my pony and my friends."*
>
...
## Pre-K Letter (picture-heavy, simpler)
...
# Visit 2 — Syllables & Sentences

**Theme:** Words have parts. The pony helps us count them.
**Pillar:** Phonemic & phonological awareness — **THIS IS THE SIGNATURE WEEK**

This is the week the pony earns her paycheck. She paws her hoof to count syllables. Kids count along. The science of reading research shows phonological awareness is the strongest single predictor of early reading success. Almost no other equine literacy program in the country teaches it this way.
...
| | Pre-K | K-2 |
|---|---|---|
| **New words mastered** | brown, white, hay, friend, gentle | and, see, can, like, my |
| **Signature skill** | Syllable counting (1, 2, 3 beats) with the pony's hoof | Syllable counting with the pony + sentence building |
| **Standards** | Pre-reading concept | K.RF.2.b / 1.RF.2 (phonological awareness) |
| **Book** | Friendship picture book | *The Girl Who Loved Wild Horses* |

---

# Pony Post #2 — Between Visit 2 and Visit 3

## K-2 Letter

> Hi class!
>
> Wow. Last week was so special. I have a confession — I almost couldn't stop pawing once I got going. Stacie had to give me extra hay.
>
> Did you stomp syllables at home? Did you count *Ap-pa-loo-sa*? I bet you did.
>
> I have been thinking about you all week. Here is what I want you to do this week.
>
> Pick one book from your bookshelf. Any book. A book you LOVE. Bring it to class next Wednesday.
>
> Because next week — and this is the BIG news — **you get to read your book out loud to me.**
>
> Don't worry, I won't laugh if you stumble on a word. I just love hearing voices. Stacie tells me you are getting so good at reading.
>
> Five new words to practice this week: **he, she, we, said, go**
>
> Try this:
>
> *"She said we can go see the pony!"*
>
...
> Hi friends!
>
> [picture of pony with another small animal]
>
> I have **friends**. Look — this is my goat friend. *Goat* is one stomp. *Pon-y* is two stomps.
>
...
# Visit 3 — Read to the Pony / Pony's Friends

**Theme:** YOU read. The pony listens.
**Pillar:** Reading fluency

This is the centerpiece of the entire Sprint for K-2 — and the most documented mechanism. Reading aloud to a non-judging animal audience doubles time-on-task for emerging and struggling readers.

## Pre-K Track — 25 minutes — "Pony's Friends"
...
| | Pre-K | K-2 |
|---|---|---|
| **New words mastered** | share, kind, help, listen, breathe | he, she, we, said, go |
| **Signature skill** | Listening comprehension, body-anchored vocabulary | **Oral reading fluency** — the literacy intervention the whole program is built around |
| **Standards** | Pre-reading | 1.RF.4 / 2.RF.4 (read with accuracy and fluency) |
| **Book** | Friendship picture book | *Little Black, A Pony* (Walter Farley) |

---

# Pony Post #3 — Between Visit 3 and Visit 4

## K-2 Letter

> Dear class,
>
> I am writing this letter with tears in my pony eyes. (Yes, ponies cry. Ask Stacie.) Last week was the most special day of my life. **You read to ME.**
>
> Do you know how many ponies in the world have ever been read to by a real class? Not many. You changed my whole year.
>
> I have one more visit with you next week. And I have BIG news. My friend wants to come too. Her name is **Abby**. She is a Clydesdale. She is the size of TWO big school buses stacked on each other. (Okay maybe one bus. But she is HUGE.)
>
> Stacie also has a wagon Abby can pull. If your teacher and your principal and your parents say yes, **we might come pick you up at school for a field trip to my farm in Athol.** If a field trip isn't possible, I'll bring Abby to your school instead. Either way, our last day together is going to be special.
>
> Five new words for the final week: **this, was, with, are, on**
>
> Try this:
>
> *"This was the best day with my pony and my friends. We are happy. The book is on the table."*
>
...
> Hi friends!
>
> [picture of pony standing next to a HUGE Clydesdale silhouette]
>
> I have a BIG friend. Her name is **Abby**. She is a Clydesdale. She is the BIGGEST horse you will EVER see.
>
...
# Visit 4 — The Big Day (with Abby the Clydesdale)

**Theme:** Celebration. Goodbye. Meet the giant.
**Pillar:** Comprehension + mastery — putting it all together

Two formats depending on whether the school approves a field trip.

## Option A — Field trip to the farm (preferred)

This is your photo deliverable. Photo releases signed in advance.

### K-2 Field Trip (90–120 min at the farm)
...
| 5 min | Goodbye + sticker book completion party + take-home magnet. |

## Option B — Final school visit

If field trip isn't approved (cost, transport, district policy), Abby comes to the school.
...
## Take-Home Gifts (both formats, both tracks)

- **Pony Passport** (K-2) or **Pony Post Sticker Book** (Pre-K), stamped with the Reading Star or Pony Friend
- **Reader Certificate** — 8.5×11, signed with a pony hoof-print stamp
- **Photo magnet** of the pony (no kid faces if printed in advance — pony only, with sponsor logo)
- **Take-Home One-Pager** for parents

## Literacy lesson summary

| | Pre-K | K-2 |
|---|---|---|
| **New words mastered** | big, small, together, ranch, goodbye | this, was, with, are, on |
| **Signature skill** | Compare/contrast (big vs. small), opposites | **All 20 sight words mastered + reading comprehension** (book discussion + word recognition assessment for sponsor data) |
| **Standards** | Pre-reading | K.RF.4 / 1.RF.4 (read with purpose and understanding) + cumulative sight word standards |
| **Book** | Friendship/compare-contrast picture book | *Misty of Chincoteague* (Marguerite Henry) — wild pony swim excerpt |
...
A single 25–45 minute classroom visit that introduces a school to The Pony Post. NOT part of a 4-week Sprint. Use it to land a school that has never worked with Tribal Cowboy before.

Two jobs:
1. Give the kids a great experience and the teacher a great photo
2. Convert the school into a **4-Week Sprint customer** for the following semester

## When to offer a demo

- A new school that asks "can you come visit?" but isn't ready for four weeks
- A preschool director who wants to test before committing
- A library, homeschool co-op, or microschool wanting a one-time event
- An admin who needs to see it before recommending it to their board

## What to charge

- **For schools (potential Sprint customers):** Free. The demo is your sales call.
- **For private events (e.g., a homeschool co-op that won't run a Sprint):** $250 flat for 45 minutes + mileage outside North Idaho.
...
1. **Hand out a Souvenir Mini-Passport** (single folded page) instead of the full Pony Passport. Tell the kids: *"If your teacher decides we should come back four more times, you'll get a real Pony Passport AND four Pony Post letters in the mail."* That single line turns kids into Sprint advocates.

2. **Hand the teacher the Sprint One-Pager** in person before you leave. Don't leave it on a desk.

3. **Send the post-visit follow-up email within 24 hours.**

## Demo Logistics

**Day before:** Confirm everything by email. Wash the pony, trim hooves. Pack the truck.

**Morning of:** Arrive 30 min early. Set up in one fixed location. Walk the pony around the empty room before kids arrive. Greet the teacher by name, hand her a $15 framed pony photo as a thank-you gift — biggest goodwill purchase you'll ever make.

**Before you leave:** Hand the teacher the Sprint One-Pager. Get her full name, email, phone. Ask: *"Would you mind sharing one sentence about how the visit went?"*

**Within 2 hours of leaving:** Batch photos through the Tribal Cowboy overlay template. Upload to a single class gallery titled *Mrs. [Teacher Name]'s Class — [School] — [Date]*. Generate one QR code. Email the teacher with the QR and a paragraph to forward to parents.

**Within 24 hours:** Send the follow-up email (template at the bottom of this doc).

---

# The Pony Passport (K-2 Take-Home Booklet)

8-page stapled booklet handed out at Visit 1. Kid completes across all 4 weeks.

| Page | Content |
|---|---|
| Cover | "My Pony Passport — [Kid's Name]" + space to draw the pony |
| 1 | My name, my school, my grade. Self-portrait space. |
| 2 | **Sight Words I Learned** — all 20 words listed, check off week by week |
| 3 | **Syllable Beats** — kids write 4 of their favorite words and mark each syllable beat |
| 4 | Draw your favorite part of Visit 1 |
| 5 | Draw your favorite part of Visit 2 |
| 6 | Draw your favorite part of Visit 3 |
| 7 | Draw your favorite part of Visit 4 |
| 8 | **Reader Certificate** — stamped at Visit 4. "I read to a pony and I am a Reading Star." |

**Optional add-on page** *("Words from the Land")* — Nisenan Maidu and Schitsu'umsh words for "horse." Use only when the school has explicitly asked for cultural programming. Mark this page **optional** and skip it for general North Idaho schools.

---

# The Pony Post Sticker Book (Pre-K Take-Home Booklet)

4-page stapled mini-book.

| Page | Content |
|---|---|
| Cover | "My Pony Post — [Kid's Name]" + a sticker of the pony |
| 1 | Visit 1 sticker + the word "soft" + drawing space |
| 2 | Visit 2 sticker + the word "gentle" + drawing space + 3 little hoofprints to count |
| 3 | Visit 3 sticker + the word "friend" + drawing space |
| 4 | Visit 4 sticker + "I met Abby!" + drawing space |
...
> tribalcowboy.com
> info@tribalcowboy.com
> 208-XXX-XXXX

## Back

> **[K-2] The 20 sight words your child now knows:**
> I, am, a, the, you, and, see, can, like, my, he, she, we, said, go, this, was, with, are, on
>
> **[Pre-K] The 20 new words your child practiced:**
...
Send to the lead teacher AND principal/director within 24 hours of any demo or final visit.

```
Subject: Thank you + a small follow-up from our visit

Hi [Name],

Thank you so much for hosting our pony and me today at [School Name].
Today was one of those visits where I came home reminded why I do
this work. Your students were [one specific real observation:
"so curious," "so kind to the pony," "asking the smartest questions"].

A few things from my end:

1. Photos. I've attached a few wide shots from the visit. None
   include kid faces, but the school is welcome to use them in
   newsletters or social posts if you'd like.

2. A small thank-you. The framed photo is for your classroom —
   pin it wherever your students will see it most.

3. The bigger conversation. Today was [a one-time visit / the
   final visit of our Sprint], but Tribal Cowboy runs The Pony Post —
   a 4-week reading program. Pre-K Track for ages 3-5 (vocabulary
   + syllable counting + sensory) and K-2 Track for ages 5-8
   (Idaho ELA sight words + syllable counting + reading fluency).
   ...
   [School Name] next semester, I'd love a 15-minute call.

4. Two small asks (if you have a minute):
   - Could you share one sentence about how the visit went? Even
     something short like "the kids loved the pony and were still
     talking about her at pickup" is gold for me.
   - Are there 1-2 other teachers or schools nearby you'd
     recommend I reach out to?
...
# Capture Plan (every visit)

Every visit is potential case-study material. Capture deliberately.

**Photos** (no kid faces unless releases are signed):
- Wide shot of the room with the pony in center
- Pony + teacher (with permission)
- Pony with materials (sight word cards, books, schedule board)
- Empty room setup before kids arrive
- Backs-of-heads shot of kids gathered around the pony
- Detail shots: hoof, mane, schedule board, hands on hay
...
- The single best thing a kid said
- The single best thing the teacher said
- The activity that worked best, the one that flopped
- Pony's mood throughout
- Any teacher mention of running another Sprint

**Numbers:** total kids, total teachers/staff, number of classrooms.

**Contacts:** teacher's full name, email, phone. Director/principal info. Any staff who showed interest in the Sprint.
...
**Before the visit:**
- If you know a student typically has trouble with new people or animals, let me know — I'll plan a softer first interaction
- Send the Welcome Letter home so parents can talk about it with their child
- Have a "quiet corner" available — a spot a kid can move to if they need a break. They will not be excluded.
...
# Pony Welfare Protocol

A pony doing 4–6 sessions per week is a working pony. Stress signals to watch for:
...
If you see any of these: cut the session short, 30 min quiet, water, hay. Reschedule if needed.

**Pick the right pony for school work.** The one who LOVES kids, stays calm under pressure, paws on cue, and is food-motivated. Required between visits: 24+ hours of recovery time.

---

# Outcomes You Can Report to Sponsors

- **Number of students served** (target: 15–25 per Sprint, 60–100 across 4 sprints/year)
...
- **Highlight reel:** 60–90 sec for sponsor reports and Instagram
...
| Window | Sprint | Notes |
|---|---|---|
| **Sep–early Oct** | Fall Sprint 1 | Start of school year |
| **November** | Heritage Sprint | Align to Native American Heritage Month — use Version B opening + the Indigenous-themed book |
| **Jan–Feb** | Winter Sprint | Indoor only (classroom/gym) |
| **Mar–April** | Spring Sprint | Field trips become viable at Visit 4 |
| **May** | Final Sprint | Finish before end of school year |

Six sprints per school year is comfortable. Eight is the cap.

---

# Read-Aloud Book Rotation

The default rotation is 3 mainstream classics + 1 Native-authored Caldecott. Rotate over the years to keep the program fresh.

**Default rotation:**
- Visit 1 — *Cowgirl Kate and Cocoa* (Erica Silverman)
- Visit 2 — *The Girl Who Loved Wild Horses* (Paul Goble) [the one Native-themed pick]
- Visit 3 — *Little Black, A Pony* (Walter Farley)
- Visit 4 — *Misty of Chincoteague* (Marguerite Henry) — excerpt

**Backups for variety:**
- *Pony Scouts: The New Pony*
- *My Pony* (Susan Jeffers)
- *A Pony for Keeps* (Susan Saunders)
- *Are You Quite Polite?* (Alan Katz)
- *Fry Bread* (Kevin Noble Maillard) — second Native-authored option if you want one in rotation

**For Pre-K (short, rhythmic, picture-heavy):**
- *Brown Bear, Brown Bear* — Bill Martin Jr. (substitute "pony" into the rhyme)
- Short horse-themed board books

---

# Sponsor Logo Placement

- Take-Home One-Pager (back side, "made possible by")
- Reader Certificate (small, bottom corner)
- Visit 4 photo backdrop (subtle)
- Tribal Cowboy social posts about the Sprint
- Sponsor's own materials (give them photos + a one-paragraph blurb)

---

# Print Checklist Before Each Sprint

| Item | Quantity | Notes |
|---|---|---|
| Welcome Letter (pre-Visit 1) | 1 per class | Teacher reads aloud |
| Visual schedule board cards (laminated) | 1 set per pony | Reusable |
| Pony Passport booklets (K-2) | 1 per kid + 10% | Print, fold, staple |
| Pony Post Sticker Books (Pre-K) | 1 per kid + 10% | Same |
| Sight word cards (K-2) | 1 set of 20, laminated A4 | Reusable across sprints |
| Pony Post Letters 1, 2, 3 | 1 per kid per letter | Print, fold, slip into pony-stamped envelope |
| Reader Certificates | 1 per kid | 8.5×11, hoof-stamped at Visit 4 |
| Photo magnets (Visit 4) | 1 per kid | Pre-printed with pony photo + sponsor logo |
| Take-Home One-Pagers | 1 per kid | Double-sided |
| Souvenir Mini-Passports (demo visits) | 1 per kid | Single folded page |
| Liability waivers | 1 per kid + adult helper | Signed before Visit 1 |
| Photo releases | 1 per kid | Signed before Visit 4 |
| Regional map | 1–2 laminated | For Visit 2 |
| Read-aloud books | 4 books total | Stacie's copies, reusable |
| Stickers (Pre-K) | 4 per kid per Sprint | Pony or Tribal Cowboy logo |
