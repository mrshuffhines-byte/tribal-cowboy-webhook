# Equine Reading Program — Week 1: Meet the Herd

**Program:** Tribal Cowboy Equine Reading Program (4-week series)
**Week:** 1 of 4
**Theme:** *Quiet voices. Horses listen with their whole body.*

A literacy-and-land program where kids read aloud to real horses. It is built for schools, homeschool co-ops, libraries, and youth groups in North Idaho and Eastern Washington. Reading-shy kids get a non-judging audience. Strong readers get a calmer, deeper one. Every student gets an animal that listens.
...
If those three things happen, Week 1 worked. Reading gains are a Week 3 and Week 4 conversation.

---

## Session Flow (90 minutes)

### 1. Welcome Circle — 10 min
- Stacie introduces herself, the land, and the herd.
- Brief, dignified acknowledgment: Nisenan Maidu heritage, what it means to learn alongside animals on this land.
- Two ground rules, no more: *quiet voices, slow hands.*

### 2. Reading the Horse — 15 min
Before kids read *to* a horse, they learn to *read* one.
- Ears: forward = curious. Pinned back = leave space.
- Eyes: soft = relaxed. Wide white = scared.
- Tail: still = calm. Swishing hard = annoyed.
- Breath: a horse that sighs near you is telling you something good.
...
### 6. Take-Home — 5 min
Each student gets:
- The **4-Week Reading Log** (a one-page tracker with space to log the book, the horse, and a drawing).
- A QR code for their group photo with the herd. Photos land on their phone (or their teacher's) within an hour.
...
- One branded group photo per student, QR-delivered
- Stacie and one assistant on-site for the full session

## What the School / Group Provides

- Books at appropriate reading level (3–5 titles per student)
- Permission slips signed in advance
- One adult chaperone per six students
- Water bottles, weather-appropriate clothing, closed-toe shoes
...
This is not a "cultural component" tacked onto a reading program. It is how the whole program is run. Stacie is Nisenan Maidu and runs this the way she runs everything else — grounded, calm, no pressure.
...
If you got all three, Week 1 worked.
...
Half-day program format. Starting at $350 for a single session, with package pricing for the full 4-week series. Title I schools and 501(c)(3) nonprofits — ask about the discount.

- **Check your date:** www.tribalcowboy.com/contact
- **Call:** (208) 261-2092
- **Email:** info@tribalcowboy.com

Indigenous Owned · Nisenan Maidu · Athol, Idaho
